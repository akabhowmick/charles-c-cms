...
/**
 * Seed content for the year-in-review series on /footsteps.
 *
 * Live data comes from the Supabase `reviews` table (see supabase/reviews.sql). This
 * array is the fallback used in mock mode and when a fetch fails, so the page never
 * renders empty.
 */
