> **Project Adoption Note** — mirrored from [fecarrico/A11Y.md](https://github.com/fecarrico/A11Y.md/blob/main/docs/en/A11Y.md) on 2026-08-08.
> **Adopted Compliance Profile:** ⚖️ Standard (AA) — see Section 0.1 below.
> **Governance artifacts in use:** [REPORT.md](REPORT.md) · [EXCEPTIONS.md](EXCEPTIONS.md) · [A11Y-DECISIONS.md](A11Y-DECISIONS.md) (all versioned, never gitignored, per Section 2).
> `references/` and `templates/` are not mirrored locally (per the guide's own Lazy Context Loading rule) — resolve them against the upstream repo at `https://github.com/fecarrico/A11Y.md/tree/main/docs/en/` when a triggering event needs a template.

# A11y Guidelines: Accessibility as a Baseline
> **Version:** 1.3.0 | **Target Standard:** WCAG 2.2 AA | **Last Updated:** 2026-08-07
...
**Project Artifacts** *(versioned, not optional — see Sections 2 and 7):* [Accessibility Report](REPORT.md) · before each delivery | [Exceptions Log](EXCEPTIONS.md) · whenever a deviation is accepted | [Decisions Log](A11Y-DECISIONS.md) · at each choice between conformant alternatives
